...
export class EditarPerfilComponent implements OnInit {
  ...
  ngOnInit() {
    this.usuario = {nombre:"",apellido:"",nick:this.nick,email:"",estrellas:0,tags: this.tagsEdit,imagen:"",password:"",actividadesPropietario:[], rol: "normal",actividadesCliente:[],_id:0,__v:0}
